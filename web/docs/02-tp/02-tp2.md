...
7. Bonus – Amélioration de l’affichage (facultatif)  

### Partie 2 – Donjon
8. Définir les variables et le tableau du donjon  
9. Afficher le donjon avec la position du joueur  
10. Proposer des déplacements valides (N, S, E, O)  
11. Mettre à jour la position et marquer les salles visitées  
12. Créer un menu de navigation complet  
...
## Étape 9 — Afficher le donjon avec la position du joueur
...
## Étape 10 — Afficher les options de déplacement
