...
🎁📦 Tout le HTML et le CSS de l'application vous sont fournis. Cliquez ici. (⛔ Ahem... bientôt dispo)
...
musicales en utilisant les API **Spotify**, **Youtube** et **BandsInTown**. Nus utiliserons
...
* Un bouton sous chaque chansons permet d'afficher la chanson dans un **lecteur YouTube** pour la faire jouer
...
1. 📦 Créer tous les composants dont vous aurez besoin. (Cours 5)
    ...
    * ⛔ Le HTML et le CSS de départ fournis ne convient pas du tout à la structure d'un projet Angular ! Il faudra tout restructurer
