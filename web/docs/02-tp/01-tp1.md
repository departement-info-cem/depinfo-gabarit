...
## 👩‍💻👨‍💻 Création du projet
Assurez-vous de cocher l'option ✅ **N'utilisez pas d'instructions de niveau supérieur.** lors de la création du projet.

![Création du projet](_01-tp1/projet.png)

De cette façon vous aurez un projet de départ avec un fonction `Main` comme celui ci
...
2. Appeler des méthodes pour :
   ...
   - Obtenir la vitesse du personnage
...
Pour afficher la classe, vous pouvez utiliser seulement le caractère (G, M ou V)
