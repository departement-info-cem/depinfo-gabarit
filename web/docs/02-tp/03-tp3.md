...
fonction RechercherEquipementDansSac(equipementRecherche)
    ...
    répéter pour i de 0 à taille de gSacADos - 1
...
static void Combat()
{
    Console.WriteLine("Débute d'un combat contre un ennemi avec " + ennemiPV + " points de vie");
}
```
...
Débute d'un combat contre un ennemi avec 5 points de vie
Débute d'un combat contre un ennemi avec 15 points de vie
Débute d'un combat contre un ennemi avec 10 points de vie
